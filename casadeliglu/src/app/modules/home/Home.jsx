...
import { getProductosMasVendidosService, getProductosService } from '../../services/productos/productoService';
...
export const Home = () => {
  ...
  const obtenerProductosMasVendidos = () => {
    getProductosMasVendidosService().then((data) => {
      setProductos(JSON.parse(data.data))
    }).catch((error) => {
      console.log(error)
    })
  }
